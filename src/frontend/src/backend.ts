...
import type { ExternalBlob as _ExternalBlob, ProductInput as _ProductInput, ProductOutput as _ProductOutput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: ProductInput): Promise<ProductOutput> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(await to_candid_ProductInput_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ProductOutput_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async filterByCategory(arg0: string): Promise<Array<ProductOutput>> {
        if (this.processError) {
            try {
    ...
    async getAllProducts(): Promise<Array<ProductOutput>> {
        if (this.processError) {
            try {
    ...
    async getCallerCart(): Promise<CartOutput> {
        if (this.processError) {
            try {
    ...
    async getCallerCartItemCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerCartItemCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProduct(arg0: string): Promise<ProductOutput> {
        if (this.processError) {
            try {
    ...
    async getTimeNow(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTimeNow();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByName(arg0: string): Promise<Array<ProductOutput>> {
        if (this.processError) {
            try {
...
async function from_candid_ProductOutput_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductOutput): Promise<ProductOutput> {
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductOutput>): Promise<Array<ProductOutput>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ProductOutput_n13(_uploadFile, _downloadFile, x)));
}
